        ...
        if(count($arr)<=0){
            ...
            foreach($arr as $v){
                ...
                $index .= "<tr>";
                    ...
                    $index .= "<td><a href='./meyarticleedit.php?conid={$v['conid']}'><button type=\"button\" class=\"btn btn-info\">編輯</button><a></td>";
                    if($v['status'] == 1){
                        $index .= "<td><a href='../../back/controller/meyarticledel.php?conid={$v['conid']}&status=0'><button type=\"button\" class=\"btn btn-success\">公開中</button></a></td>";
                    }else{
                        $index .= "<td><a href='../../back/controller/meyarticledel.php?conid={$v['conid']}&status=1'><button type=\"button\" class=\"btn btn-danger\">封鎖中</button></a></td>";
                    }
